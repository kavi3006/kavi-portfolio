                ...
                <div className="projects-grid">
                    ...
                    <div className="project-card">
                        ...
                        <div className="project-info">
                            ...
                            <div className="project-links">
                                <a href="https://wealthwise-finance.streamlit.app/" className="btn small-btn" target="_blank" rel="noopener noreferrer"><i className="fas fa-link"></i> Live Demo</a>
                                <a href="https://github.com/kavi3006/WealthWise" className="btn small-btn" target="_blank" rel="noopener noreferrer"><i className="fab fa-github"></i> Code</a>
                            </div>
                        </div>
                    </div>
                    <div className="project-card">
